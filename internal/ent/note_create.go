...
func (nc *NoteCreate) SetName(s string) *NoteCreate {
	nc.mutation.SetName(s)
	return nc
}

// SetNillableName sets the "name" field if the given value is not nil.
func (nc *NoteCreate) SetNillableName(s *string) *NoteCreate {
	if s != nil {
		nc.SetName(*s)
	}
	return nc
...
func (nc *NoteCreate) SetNoteID(u uint) *NoteCreate {
	nc.mutation.SetNoteID(u)
	return nc
}
...
func (nc *NoteCreate) check() error {
	...
	if _, ok := nc.mutation.NoteID(); !ok {
		return &ValidationError{Name: "note_id", err: errors.New(`ent: missing required field "note_id"`)}
	}
	if _, ok := nc.mutation.CreatedAt(); !ok {
...
func (nc *NoteCreate) createSpec() (*Note, *sqlgraph.CreateSpec) {
	...
	if value, ok := nc.mutation.NoteID(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint,
			Value:  value,
