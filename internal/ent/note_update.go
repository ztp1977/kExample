...
func (nu *NoteUpdate) SetName(s string) *NoteUpdate {
	nu.mutation.SetName(s)
	return nu
}

// SetNillableName sets the "name" field if the given value is not nil.
func (nu *NoteUpdate) SetNillableName(s *string) *NoteUpdate {
	if s != nil {
		nu.SetName(*s)
	}
	return nu
...
func (nu *NoteUpdate) SetNoteID(u uint) *NoteUpdate {
	nu.mutation.ResetNoteID()
	nu.mutation.SetNoteID(u)
	return nu
}

// AddNoteID adds u to the "note_id" field.
func (nu *NoteUpdate) AddNoteID(u uint) *NoteUpdate {
	nu.mutation.AddNoteID(u)
	return nu
}
...
func (nu *NoteUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := nu.mutation.Name(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			...
			Value:  value,
			Column: note.FieldName,
		})
	}
	if value, ok := nu.mutation.NoteID(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeUint,
			Value:  value,
			Column: note.FieldNoteID,
		})
	}
	if value, ok := nu.mutation.AddedNoteID(); ok {
...
// SetName sets the "name" field.
func (nuo *NoteUpdateOne) SetName(s string) *NoteUpdateOne {
	nuo.mutation.SetName(s)
	return nuo
}

// SetNillableName sets the "name" field if the given value is not nil.
func (nuo *NoteUpdateOne) SetNillableName(s *string) *NoteUpdateOne {
	if s != nil {
		nuo.SetName(*s)
	}
	return nuo
...
// SetNoteID sets the "note_id" field.
func (nuo *NoteUpdateOne) SetNoteID(u uint) *NoteUpdateOne {
	nuo.mutation.ResetNoteID()
	nuo.mutation.SetNoteID(u)
	return nuo
}

// AddNoteID adds u to the "note_id" field.
func (nuo *NoteUpdateOne) AddNoteID(u uint) *NoteUpdateOne {
	nuo.mutation.AddNoteID(u)
	return nuo
}
...
func (nuo *NoteUpdateOne) sqlSave(ctx context.Context) (_node *Note, err error) {
	...
	if value, ok := nuo.mutation.NoteID(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeUint,
			Value:  value,
			Column: note.FieldNoteID,
	...
	if value, ok := nuo.mutation.AddedNoteID(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeUint,
			Value:  value,
			Column: note.FieldNoteID,
